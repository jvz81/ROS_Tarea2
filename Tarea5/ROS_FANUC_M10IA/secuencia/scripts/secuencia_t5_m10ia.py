...
brazo_m10ia = MoveGroupPythonInterface("m10ia")     #nombre del planning group
                       #devuelve 3 valores
joint_list, cartesian_position, cartesian_orientation = brazo_m10ia.get_position()
print(cartesian_position)

brazo_m10ia.go_to_home()

brazo_m10ia.scale_ROT = 1.5708
brazo_m10ia.joints_move("j3","reverse")     #mueve J3 90 grados

brazo_m10ia.scale_LIN = 0.25                               #cuanto se mueve linealmente 1 = 1 metro
brazo_m10ia.cartesian_pos("x","forward")
brazo_m10ia.cartesian_pos("z","reverse")        #se mueve x y z para intentar chocar

brazo_m10ia.joints_move("j1","reverse")         #busca chocar contra el pilar


brazo_m10ia.joints_move("j2","forward")
brazo_m10ia.cartesian_pos("x","forward")
brazo_m10ia.joints_move("j1","forward")
