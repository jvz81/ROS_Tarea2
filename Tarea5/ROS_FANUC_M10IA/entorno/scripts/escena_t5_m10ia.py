...
def main():
    ...
    group_name = "m10ia"  #planing group
    ...
    aux_pose.header.frame_id = "base_link"
    aux_pose.pose.orientation.w = 1.0
    aux_pose.pose.position.x = 1
    aux_pose.pose.position.y = -0.5
    aux_pose.pose.position.z = 0.2
    box_name = "obstaculo"
    scene.add_box(box_name, aux_pose, size=(0.25, 0.25, 2))
    #----------------------------PISO
